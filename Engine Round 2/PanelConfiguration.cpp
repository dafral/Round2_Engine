...
{
	ImGui::TextColored(ImVec4(0.6, 0.2, 0.6, 1), "Renderer Configuration");
...
{
	ImGui::TextColored(ImVec4(0.6, 0.2, 0.6, 1), "Window Configuration");
}

void PanelConfiguration::InputConfig()
{
	ImGui::TextColored(ImVec4(0.6, 0.2, 0.6, 1), "Input Configuration");
}

void PanelConfiguration::TexturesConfig()
{
	ImGui::TextColored(ImVec4(0.6, 0.2, 0.6, 1), "Textures Configuration");
}