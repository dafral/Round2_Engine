...
{	
	DeleteFolder(assets_path, true);
	DeleteFolder(library_path, true);
...
int ModuleFileSystem::DeleteFolder(const std::string &refcstrRootDirectory, bool bDeleteSubdirectories = true)
{
